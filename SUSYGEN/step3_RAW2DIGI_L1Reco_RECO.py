...
# with command line options: step3 --step RAW2DIGI,L1Reco,RECO --conditions=START61_V11::All --pileup NoPileUp --customise Configuration/GlobalRuns/reco_TLR_42X.customisePPMC --datatier GEN-SIM-RECO --eventcontent AODSIM --no_exec
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:Try_step2_DIGI_L1_DIGI2RAW_HLT_PU.root')
...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('try_GMSB_Lambda180_CTau12000_8TeV_pythia6_Sum12_PU_50ns_RECO.root'),
